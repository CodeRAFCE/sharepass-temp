    ...
    return (
        <div className="single_blog">
            ...
            <div className="date_line">
                ...
                <p className="date">  {props.date ? formatDate(props.date) : ''}</p>
            ...
            <h1 className="blogtitle">{props.title && props.title.rendered ? decodeHtml(props.title.rendered) : ''}</h1>
            ...
            <article>              
              <div className="blog_injector">
                <p style={{ fontWeight: 400 }}>                  
                  <div dangerouslySetInnerHTML={{ __html: props.has_excerpt && props.excerpt && props.excerpt.rendered ? props.excerpt.rendered : '' }} className="container_wrap" />
                </p>
                <p>                  
