...
const SharePassOne = () => {
    ...
    const getVideoTutorials = async () => {
        ...
        await axios.get(`${apiUrl}wp-json/youtube/v1/videos?playlist=PLX59VfUF4v2Bd8wiMfD03AsdE6RgjXC9A`)
        .then((response) => {
    ...
    return <>
        <Helmet>
            <title>How to use SharePass One | SharePass</title>
            <meta property="description" content={defaultMetaDescription} />
            <meta property="og:title" content="How to use SharePass One | SharePass" />
